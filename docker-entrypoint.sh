...
#fi
#
### Adding varnish acl rules for purge
#myip="$(ip r | grep src | awk -F " " '{print $1}')"
#myip_clean="$(echo $myip | sed "s#/#\\\/#g")"
#sed -e 's/##SUBSTITUTE##/##SUBSTITUTE##\n    \"'${myip_clean}'\";/g' -i /etc/varnish/default.vcl
#
#exec varnishd \
#        -F \
#        -a :6081 \
